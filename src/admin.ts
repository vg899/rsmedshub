        ...
        overlay.innerHTML = `
          ...
          <div class="space-y-4 max-w-sm">
            ...
            <p class="text-xs text-slate-400 font-semibold leading-relaxed px-4">
              This is an isolated portal. You are trying to access the <strong>ADMIN</strong> panel, but your account is registered as <strong>${(data.role || "unknown").toUpperCase()}</strong>.
            </p>
